...
TODO: investigate those tweets, especially "Checkout why PrEP is hurting the cause"

User 711275699529764864 appears to be a twitter spam bot with no obvious connection to PrEP. Thus while we observe some noise, our results demonstrate a way to quickly identify and monitor the most viral tweets related to PrEP. As the discussion changes, public health professionals can use this information to quickly identify the most relevant viral sentiment in the online PrEP conversation.
...
TODO: investigate the reference to  \#truvadawhore which came up in the sentiment tweets above.
